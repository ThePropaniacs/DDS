...
{
    public class EmployeeAddUserService
    {
        public async Task<IdentityResult> AddUserEmployee(NewEmployeeUserInputModel model, ApplicationUserManager UserManager)
        {
